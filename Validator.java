...
public class Validator extends Client{
    ...
    public Validator(String nci, String nomComplet) {
        super(nci, nomComplet, nomComplet);
    }

    public Validator(String nci, String nomComplet, int tel, String adresse, String email) {
    ...
    public static boolean isValidPhone(String tel) {
        String expression = "^\\d{2}[  ]?\\d{3}[  ]?\\d{2}[  ]?\\d{2}$";
